...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <p :style="{color: textColor, fontSize: fontSize + 'px'}">George Orwell</p>
    </section>
  </div>
</template>
...
// EFOLIO TASK 2.2 (DISTINCTION AND HIGH DISTINCTION LEVEL) 
// Use attribute, class and style bindings to highlight author "George Orwell"
...
<!-- 在 Vue.js 的 v-for 指令中，遍历对象时 (value, key) 的顺序是有要求的：value 必须在前，key 必须在后。具体来说：
  第一个参数是对象的值。
  第二个参数是对象的键。
-->