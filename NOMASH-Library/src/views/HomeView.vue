      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control" id="reason" rows="3" v-model="formData.reason" @blur="() => validateReason(true)" @input="() => checkForFriendMessage(true)"></textarea>
            <div v-if="errors.reason" class="text-danger">{{ errors.reason }}</div>
            <div v-if="friendMessage" class="text-success" style="color: green;">{{ friendMessage }}</div>
          </div>
          <div class="mb-3">
